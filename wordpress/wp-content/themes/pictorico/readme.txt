...
Donate link:
Tags: black, blue, dark, one-column, fixed-layout, responsive-layout, custom-background, custom-header, custom-menu, editor-style, featured-images, featured-image-header, post-formats, rtl-language-support, sticky-post, translation-ready, featured-content-with-pages
Tested up to: 3.9
Stable tag: 3.7
